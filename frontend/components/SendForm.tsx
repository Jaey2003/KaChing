...
export default function SendForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push(`/compare?amount=${amount}&asset=${selectedAsset}&${pocketParams}`);
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-4">
        {/* Asset Selection Dropdown / Static Display */}
        ...
        <div className="pt-2">
          ...
          <button
            type="button"
            onClick={addPocket}
            className="mt-4 w-full py-2.5 border border-dashed border-white/20 rounded-xl text-gray-400 text-sm hover:border-primary/50 hover:text-primary transition flex items-center justify-center gap-2"
          >
